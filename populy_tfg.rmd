...
Sin embargo, estas y otras tecnologías raramente se reflejan en las aulas de biología. Analizando la carga lectiva de la informática en los grados de ciencias biológicas se ve que suponen de entre 0 a 10 créditos, dependiendo de la carrera y la optatividad, esto es menos de un `r (12/240)*100`% del total. La realidad es que las matemáticas y la informática, piezas clave en estos avances, parecen relegadas a campos más "duros" como son las ingenierías y la física.
