...
Dado que el Populy está pensado para el uso interactivo en aulas se ha creado un repositorio en *MyBinder* donde se incluyen las libretas. Se puede acceder a estas ellas pulsando al siguiente enlace [Populy repositorio](https://mybinder.org/v2/gh/R-mario/Populy-notebooks/HEAD). Estas cuatro libretas también se han añadido al [apéndice](# Apéndice) como archivos de texto plano.
